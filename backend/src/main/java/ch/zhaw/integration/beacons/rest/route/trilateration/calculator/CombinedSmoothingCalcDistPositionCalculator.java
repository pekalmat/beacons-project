...
@Component
public class CombinedSmoothingCalcDistPositionCalculator extends AbstractPositionCalculator{

    @Override
    CalculationMethod getCalculationMethod() {
        return CalculationMethod.TRILATERATION_SLDING_WINDOW_AND_KALMANN_FILTER_CALCULATED_DISTANCE;
    }
