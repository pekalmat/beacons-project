...
import ch.zhaw.integration.beacons.service.route.trilateration.calculator.basic.NoSmoothingPositionCalculator;
...
public class AbstractPositionCalculatorTest {
    ...
    public void setUp() {
        ...
        sut = new NoSmoothingPositionCalculator(calculator, null, null);
    }
    ...
    private void checkTestCase(BigDecimal xExpected, BigDecimal yExpected,
        ...
        Pair<BigDecimal, BigDecimal> resultCurrent = sut.trilateratePositionCoordinates(location1, location2, location3, distLoc1, distLoc2, distLoc3);
        System.out.println();
        ...
        Pair<BigDecimal, BigDecimal> resultNewTrill1 = sut.newTrill1(location1, location2, location3, distLoc1 ,distLoc2, distLoc3);
        System.out.println();
        ...
        /*
        Pair<BigDecimal, BigDecimal> resultNewTrill2 = sut.newTrill2(location1, location2, location3, distLoc1, distLoc2, distLoc3);
        System.out.println();
        ...
        */
        ...
        Pair<Double, Double> resultNewTrill3Library = sut.newTrill3Library(location1, location2, location3, distLoc1, distLoc2, distLoc3);
        System.out.println();
