...
class _MyAppState extends State<MyApp> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    var initializationSettingsAndroid = const AndroidInitializationSettings('app_icon'); // TODO: Add Icon image
  ...
  Future<void> initPlatformState() async {
    ...
    await BeaconsPlugin.addRegion("BeaconType1", "01122334-4556-6778-899a-abbccddeeff0");


    BeaconsPlugin.addBeaconLayoutForAndroid("m:2-3=0215,i:4-19,i:20-21,i:22-23,p:24-24"); // Add iBeacon Layout

    BeaconsPlugin.setForegroundScanPeriodForAndroid(foregroundScanPeriod: 2200, foregroundBetweenScanPeriod: 5000);

    BeaconsPlugin.setBackgroundScanPeriodForAndroid(backgroundScanPeriod: 2200, backgroundBetweenScanPeriod: 5000);
              ...
              Visibility(
                ...
                child: Padding(
                  ...
                  child: ElevatedButton(
                    ...
                    child:
                    const Text("Clear Results", style: TextStyle(fontSize: 20)),
                  ),
                ),
              ),
              const SizedBox(
